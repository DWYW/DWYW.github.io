import{_,e as i,r as o,o as s,c as d,d as n,b as a,w as l,f as x,t as b,F as v,u as y}from"./index-098e058d.js";const h=i({data(){return{ratio:"1"}}}),R={style:{width:"300px"}};function $(e,t,c,u,r,k){const p=o("YuumiInput"),m=o("YuumiRatioRect");return s(),d(v,null,[n(p,{modelValue:e.ratio,"onUpdate:modelValue":t[0]||(t[0]=f=>e.ratio=f),limit:/^\d+(\.\d*)?$/},null,8,["modelValue","limit"]),a("div",R,[n(m,{ratio:Number(e.ratio),style:{"background-color":"blue","border-radius":"4px",display:"flex","justify-content":"center","align-items":"center",color:"#ffffff"}},{default:l(()=>[x(" ratio: "+b(e.ratio),1)]),_:1},8,["ratio"])])],64)}const w=_(h,[["render",$]]),Y=`<template>
