...
<\/script>
`,B={data(){return{data:[{label:"一年级",value:1,children:[{label:"1班",value:101},{label:"2班",value:102,children:[{label:"实验班",value:10201},{label:"普通班",value:10202}]},{label:"3班",value:103}]},{label:"二年级",value:2,children:[{label:"1班",value:201},{label:"2班",value:202}]},{label:"三年级",value:3,children:[{label:"1班",value:301},{label:"2班",value:302},{label:"3班",value:303}]}]}},methods:{onChecked(e){console.log("onChecked",e)},onNodeExpand(e){console.log("onNodeExpand",e)},onNodeClick(e){console.log("onNodeClick",e)}}};function y(e,d,i,u,n,l){const c=s("YuumiTree");return h(),p(c,{inline:"",data:n.data,onChecked:l.onChecked,onNodeExpand:l.onNodeExpand,onNodeClick:l.onNodeClick},null,8,["data","onChecked","onNodeExpand","onNodeClick"])}const D=v(B,[["render",y]]),I=`<template>
  <YuumiTree
    inline
    :data="data"
    @checked="onChecked"
...
<\/script>
`,w={data(){return{data:[]}},mounted(){this.data=this.createChildren("")},methods:{createChildren(e){const d=Math.floor(5*Math.random()),i=[];for(let u=0;u<=d;u++){const n=e?`${e}-${u}`:`${u}`;i.push({label:n,value:n})}return i},loadData(e){return new Promise(d=>{setTimeout(()=>{Math.random()>.5?d(this.createChildren(e.label)):d(null)},400)})},onChecked(e){console.log("onChecked",e)},onNodeExpand(e){console.log("onNodeExpand",e)},onNodeClick(e){console.log("onNodeClick",e)}}};function M(e,d,i,u,n,l){const c=s("YuumiTree");return h(),p(c,{data:n.data,"load-data":l.loadData,onChecked:l.onChecked,onNodeExpand:l.onNodeExpand,onNodeClick:l.onNodeClick},null,8,["data","load-data","onChecked","onNodeExpand","onNodeClick"])}const P=v(w,[["render",M]]),V=`<template>
  <YuumiTree
    :data="data"
    :load-data="loadData"
    @checked="onChecked"
...
<\/script>
`,A={data(){return{data:[{label:"一年级",value:1,children:[{label:"1班",value:101,checked:!0},{label:"2班",value:102,disabled:!0,children:[{label:"实验班",value:10201},{label:"普通班",value:10202}]},{label:"3班",value:103}]},{label:"二年级",value:2,children:[{label:"1班",value:201},{label:"2班",value:202}]},{label:"三年级",value:3,expand:!0,children:[{label:"1班",value:301},{label:"2班",value:302},{label:"3班",value:303}]}]}}};function F(e,d,i,u,n,l){const c=s("YuumiTree");return h(),p(c,{data:n.data,checkable:!1},null,8,["data"])}const L=v(A,[["render",F]]),S=`<template>
...
<\/script>
`,j={data(){return{data:[{label:"一年级",value:1,children:[{label:"1班",value:101,checked:!0},{label:"2班",value:102,disabled:!0,children:[{label:"实验班",value:10201},{label:"普通班",value:10202}]},{label:"3班",value:103}]},{label:"二年级",value:2,children:[{label:"1班",value:201},{label:"2班",value:202}]},{label:"三年级",value:3,expand:!0,children:[{label:"1班",value:301},{label:"2班",value:302},{label:"3班",value:303}]}]}}};function q(e,d,i,u,n,l){const c=s("YuumiTree");return h(),p(c,{data:n.data,"expand-icon-visible":!1},null,8,["data"])}const z=v(j,[["render",q]]),G=`<template>
...
<\/script>
`,H={data(){return{data:[{icon:"line-calendar",label:"2021-12-11",value:"2021-12-11",children:[{icon:"line-clock",label:"06:00",value:"2021-12-11 06:00:00"},{icon:"line-clock",label:"08:00",value:"2021-12-11 08:00:00"},{icon:"line-clock",label:"10:00",value:"2021-12-11 10:00:00"}]},{icon:"line-calendar",label:"2021-12-12",value:"2021-12-12",children:[{icon:"line-clock",label:"06:00",value:"2021-12-12 06:00:00"},{icon:"line-clock",label:"08:00",value:"2021-12-12 08:00:00"},{icon:"line-clock",label:"10:00",value:"2021-12-12 10:00:00"}]}]}}};function J(e,d,i,u,n,l){const c=s("YuumiIcon"),m=s("YuumiTree");return h(),p(m,{data:n.data},{default:r(({node:k,isLeaf:x})=>[o(c,{icon:k.icon},null,8,["icon"]),a("span",null,f(k.label),1),x?N("",!0):(h(),p(c,{key:0,icon:"line-arrow-right"}))]),_:1},8,["data"])}const K=v(H,[["render",J]]),O=`<template>
  <YuumiTree :data="data">
