import{_ as v,r as h,o as l,c as o,F as d,a as f,b as s,t as g,d as c,w as m,e as w,f as x,g as k,h as $,i as I,n as Y,j as T,k as z}from"./index.477881a6.js";const C={data(){return{type:Array(10).fill("line")}},computed:{iconCount(){return this.icons.reduce((e,a)=>e+a.children.length,0)},icons(){return[{name:"\u5E38\u7528\u7C7B",line:["line-add","line-edit","line-loading","line-correct","line-rect-correct","line-circle-correct","line-close","line-setting","line-help","line-info","line-exit","line-delete","line-remove","line-disabled","line-search","line-praise","line-screen","line-order","line-catalog","line-menu","line-menu1","line-share","line-heart"],flat:["flat-add","flat-edit","flat-loading","flat-correct","flat-rect-correct","flat-circle-correct","flat-close","flat-setting","flat-help","flat-info","flat-exit","flat-delete","flat-remove","flat-disabled","flat-search","flat-praise","flat-screen","flat-order","flat-catalog","flat-menu","flat-menu1","flat-share","flat-heart"]},{name:"\u8868\u5355",line:["radio-selected","radio-unselected","checkbox-selected","checkbox-unselected","line-checkbox-indeterminate","line-mobile","line-phone","line-key","line-lock","line-unlock","line-circle","line-circle-dot","line-circle-close","line-rect","line-fold","line-unfold","line-eye","line-eye-close","line-shield-info","line-shield-correct","line-calendar","line-clock","line-mail","line-drag"],flat:["flat-checkbox-indeterminate","flat-mobile","flat-phone","flat-key","flat-lock","flat-unlock","flat-circle","flat-circle-dot","flat-circle-close","flat-rect","flat-fold","flat-unfold","flat-eye","flat-eye-close","flat-shield-info","flat-shield-correct","flat-calendar","flat-clock","flat-mail","flat-drag"]},{name:"\u65B9\u5411",line:["line-prev","line-next","line-arrow-top","line-arrow-bottom","line-arrow-left","line-arrow-right"],flat:["flat-arrow-top","flat-arrow-bottom","flat-arrow-left","flat-arrow-right"]},{name:"\u6587\u4EF6",line:["line-file","line-file-add","line-file-setting","line-image","line-video","line-music","line-upload","line-download","line-cloud-upload","line-cloud-download"],flat:["flat-file","flat-file-add","flat-file-setting","flat-image","flat-video","flat-music","flat-upload","flat-download","flat-cloud-upload","flat-cloud-download"]},{name:"\u6587\u4EF6\u5939",line:["line-folder","line-folder-add","line-folder-setting"],flat:["flat-folder","flat-folder-add","flat-folder-setting"]},{name:"\u4EBA\u5458\u7EC4\u7EC7",line:["line-user","line-user-add","line-user-setting","line-user-disabled","line-user-remove","line-users","line-user-order"],flat:["flat-user","flat-user-add","flat-user-setting","flat-user-disabled","flat-user-remove","flat-users","flat-user-order"]},{name:"\u72B6\u6001",line:["line-empty","line-finger"],flat:["flat-empty","flat-finger"]},{name:"\u4EA4\u901A",line:["line-car","line-steering-wheel"],flat:["flat-car","flat-steering-wheel"]},{name:"\u8BC1\u4EF6",line:["line-identity"],flat:["flat-identity"]},{name:"\u5A92\u4F53",line:["line-pause","line-play","line-voice","line-muted","line-fullscreen","line-fullscreen-exit"],flat:["flat-pause","flat-play","flat-voice","flat-muted","flat-fullscreen","flat-fullscreen-exit"]}]}}},V={style:{overflow:"hidden"}},H={class:"group-name",style:{"font-weight":"bold","padding-bottom":"10px"}},B={class:"group-icons"},D={style:{"font-size":"12px"}},N={class:"group-icons"},A={style:{"font-size":"12px"}};function R(e,a,r,p,u,i){const n=h("YuumiIcon"),j=h("YuumiTabItem"),b=h("YuumiTabs");return l(),o("div",V,[(l(!0),o(d,null,f(i.icons,(q,_)=>(l(),o("div",{key:q.name,class:"group-item"},[s("div",H,g(q.name),1),c(b,{modelValue:u.type[_],"onUpdate:modelValue":t=>u.type[_]=t},{default:m(()=>[c(j,{label:"\u7EBF\u6027",value:"line"},{default:m(()=>[s("div",B,[(l(!0),o(d,null,f(q.line,t=>(l(),o("div",{key:t,style:{display:"inline-block",width:"20%",height:"100px","font-size":"28px","vertical-align":"text-bottom","text-align":"center","font-weight":"bold"}},[c(n,{icon:t},null,8,["icon"]),s("div",D,g(t),1)]))),128))])]),_:2},1024),c(j,{label:"\u6241\u5E73",value:"flat"},{default:m(()=>[s("div",N,[(l(!0),o(d,null,f(q.flat,t=>(l(),o("div",{key:t,style:{display:"inline-block",width:"20%",height:"100px","font-size":"28px","vertical-align":"text-bottom","text-align":"center","font-weight":"bold"}},[c(n,{icon:t},null,8,["icon"]),s("div",A,g(t),1)]))),128))])]),_:2},1024)]),_:2},1032,["modelValue","onUpdate:modelValue"])]))),128))])}var S=v(C,[["render",R]]);const F={components:{ImportDemo:S}};function U(e,a,r,p,u,i){const n=h("ImportDemo");return l(),w(n)}var E=v(F,[["render",U]]);const y=x({components:{vdpv_0:E},setup(e){const a=k(),r=[a],p=$({vdpv_0Height:0});return{toggleCode:i=>{const n="vdpv_"+i;p[n+"Height"]===0?p[n+"Height"]=(r[i].value?r[i].value.offsetHeight:0)||0:p[n+"Height"]=0},...I(p),vdpv_0Ref:a}}});y.$vd={matter:{},toc:[{content:"\u57FA\u672C\u7528\u6CD5",anchor:"\u57FA\u672C\u7528\u6CD5",level:3}]};const L=y,G={class:"vuedoc"},J=s("h3",{id:"\u57FA\u672C\u7528\u6CD5","data-source-line":"1"},[s("a",{class:"markdownIt-Anchor",href:"#\u57FA\u672C\u7528\u6CD5"},"#"),T(" \u57FA\u672C\u7528\u6CD5")],-1),K=s("pre",{style:{display:"none"}},null,-1),M={class:"vuedoc-demo"},O={class:"vuedoc-demo__inner"},P={class:"vuedoc-demo__preview"},Q={ref:"vdpv_0Ref",class:"vuedoc-demo__sourceref"},W=z(`<div class="vuedoc__code"><pre class="hljs vuedoc__hljs language-vue hljs--one-light"><code><span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">template</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">style</span>=<span class="hljs-string">&quot;overflow: hidden;&quot;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span>
      <span class="hljs-attr">v-for</span>=<span class="hljs-string">&quot;group,index in icons&quot;</span>
      <span class="hljs-attr">:key</span>=<span class="hljs-string">&quot;group.name&quot;</span>
      <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;group-item&quot;</span>
    &gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span>
        <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;group-name&quot;</span>
        <span class="hljs-attr">style</span>=<span class="hljs-string">&quot;font-weight: bold; padding-bottom: 10px;&quot;</span>
      &gt;</span>
        {{ group.name }}
      ...
      <span class="hljs-tag">&lt;<span class="hljs-name">YuumiTabs</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;type[index]&quot;</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">YuumiTabItem</span>
          <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;\u7EBF\u6027&quot;</span>
        ...
        &gt;</span>
          <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;group-icons&quot;</span>&gt;</span>
            <span class="hljs-tag">&lt;<span class="hljs-name">div</span>
              <span class="hljs-attr">v-for</span>=<span class="hljs-string">&quot;icon in group.line&quot;</span>
              <span class="hljs-attr">:key</span>=<span class="hljs-string">&quot;icon&quot;</span>
              <span class="hljs-attr">style</span>=<span class="hljs-string">&quot;display: inline-block; width: 20%; height: 100px; font-size: 28px; vertical-align: text-bottom; text-align: center; font-weight: bold;&quot;</span>
            &gt;</span>
              <span class="hljs-tag">&lt;<span class="hljs-name">YuumiIcon</span> <span class="hljs-attr">:icon</span>=<span class="hljs-string">&quot;icon&quot;</span> /&gt;</span>
              <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">style</span>=<span class="hljs-string">&quot;font-size: 12px;&quot;</span>&gt;</span>
                {{ icon }}
              <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
            <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
          <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
        ...
        <span class="hljs-tag">&lt;<span class="hljs-name">YuumiTabItem</span>
          <span class="hljs-attr">label</span>=<span class="hljs-string">&quot;\u6241\u5E73&quot;</span>
          <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;flat&quot;</span>
        &gt;</span>
          <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;group-icons&quot;</span>&gt;</span>
            <span class="hljs-tag">&lt;<span class="hljs-name">div</span>
              <span class="hljs-attr">v-for</span>=<span class="hljs-string">&quot;icon in group.flat&quot;</span>
              <span class="hljs-attr">:key</span>=<span class="hljs-string">&quot;icon&quot;</span>
              <span class="hljs-attr">style</span>=<span class="hljs-string">&quot;display: inline-block; width: 20%; height: 100px; font-size: 28px; vertical-align: text-bottom; text-align: center; font-weight: bold;&quot;</span>
            &gt;</span>
              <span class="hljs-tag">&lt;<span class="hljs-name">YuumiIcon</span> <span class="hljs-attr">:icon</span>=<span class="hljs-string">&quot;icon&quot;</span> /&gt;</span>
    ...
    icons () {
      <span class="hljs-keyword">return</span> [{
        ...
        <span class="hljs-attr">line</span>: [
          ...
          <span class="hljs-string">&quot;line-drag&quot;</span>
        ],
        <span class="hljs-attr">flat</span>: [
          ...
          <span class="hljs-string">&quot;flat-drag&quot;</span>
        ]
      }, {
        ...
        <span class="hljs-attr">line</span>: [
          ...
          <span class="hljs-string">&quot;line-image&quot;</span>,
          <span class="hljs-string">&quot;line-video&quot;</span>,
          <span class="hljs-string">&quot;line-music&quot;</span>,
          <span class="hljs-string">&quot;line-upload&quot;</span>,
          <span class="hljs-string">&quot;line-download&quot;</span>,
          <span class="hljs-string">&quot;line-cloud-upload&quot;</span>,
          <span class="hljs-string">&quot;line-cloud-download&quot;</span>
        ],
        <span class="hljs-attr">flat</span>: [
          ...
          <span class="hljs-string">&quot;flat-image&quot;</span>,
          <span class="hljs-string">&quot;flat-video&quot;</span>,
          <span class="hljs-string">&quot;flat-music&quot;</span>,
          <span class="hljs-string">&quot;flat-upload&quot;</span>,
          <span class="hljs-string">&quot;flat-download&quot;</span>,
          <span class="hljs-string">&quot;flat-cloud-upload&quot;</span>,
          <span class="hljs-string">&quot;flat-cloud-download&quot;</span>
        ]
      }, {
...
</span><span class="xml"><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></span></code></pre></div>`,1),X=[W];function Z(e,a,r,p,u,i){const n=h("vdpv_0");return l(),o("div",G,[J,K,s("div",M,[s("div",O,[s("div",P,[c(n)]),s("div",{style:Y({height:e.vdpv_0Height+"px"}),class:"vuedoc-demo__source"},[s("div",Q,X,512)],4),s("div",{class:"vuedoc-demo__footer",onClick:a[0]||(a[0]=j=>e.toggleCode(0))},g(e.vdpv_0Height>0?"hidden":"show"),1)])])])}var ns=v(L,[["render",Z]]);export{ns as default};
