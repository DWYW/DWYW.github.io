import{_ as x,r,o as t,c as g,d as a,F as b,a as _,b as s,t as i,h as f,e as C,w as c,u as v,g as V}from"./index-9f5cfcb2.js";const k={data(){return{value:"17:05:04",value1:""}},methods:{onChange(o){console.log("onChange",o)}}};function y(o,n,m,p,e,u){const d=r("YuumiTimePicker");return t(),g(b,null,[a(d,{modelValue:e.value,"onUpdate:modelValue":n[0]||(n[0]=l=>e.value=l),style:{margin:"0 10px 10px 0"},"disabled-hours":()=>[19,20,21],onChange:u.onChange},null,8,["modelValue","onChange"]),a(d,{modelValue:e.value1,"onUpdate:modelValue":n[1]||(n[1]=l=>e.value1=l),style:{margin:"0 10px 10px 0"},onChange:u.onChange},null,8,["modelValue","onChange"])],64)}const P=x(k,[["render",y]]),T=`<template>
  <YuumiTimePicker
    v-model="value"
