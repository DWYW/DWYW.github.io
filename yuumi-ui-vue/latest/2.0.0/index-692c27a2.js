import{_ as g,r as u,o as p,c,F as f,a as x,d as n,w as l,f as s,t as _,e as D,u as v,g as Y,b as i}from"./index-9f5cfcb2.js";const B={data(){return{position:"right",show:!1}},methods:{showDrawer(a){this.position=a,this.show=!0}}};function b(a,e,w,h,t,r){const m=u("YuumiButton"),d=u("YuumiDrawer");return p(),c(f,null,[(p(),c(f,null,x(["right","left","top","bottom"],o=>n(m,{key:o,style:{margin:"0 10px 10px 0"},onClick:O=>r.showDrawer(o)},{default:l(()=>[s(_(o),1)]),_:2},1032,["onClick"])),64)),n(d,{modelValue:t.show,"onUpdate:modelValue":e[0]||(e[0]=o=>t.show=o),position:t.position},{default:l(()=>[s(_(t.position),1)]),_:1},8,["modelValue","position"])],64)}const L=g(B,[["render",b]]),k=`<template>
