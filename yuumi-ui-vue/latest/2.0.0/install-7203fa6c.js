import{e as s,o as a,c as p,g as t}from"./index-569afd91.js";const o={class:"markdown-body"},e=t(`<h3>快速开始</h3><pre class="language-bash"><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> yuumi-ui-vue@latest
...
</code></pre>`,6),c=[e],r={},m="",d=s({__name:"install",setup(u,{expose:n}){return n({frontmatter:{},excerpt:void 0}),(l,i)=>(a(),p("div",o,c))}});export{d as default,m as excerpt,r as frontmatter};
