import{_ as h,r as i,o as m,c as f,a as x,d as n,w as s,f as r,t as $,F as v,j as _,h as M,Y as y,e as B,u as p,b as g}from"./index-9f5cfcb2.js";const k={methods:{createMessage(e){this.$yuumi.createMessage({message:"this is a message",theme:e})}}};function Y(e,c,d,l,t,o){const a=i("YuumiButton");return m(),f(v,null,x(["default","primary","success","warn","danger"],u=>n(a,{key:u,style:{margin:"0 10px 10px 0"},theme:u,onClick:J=>o.createMessage(u)},{default:s(()=>[r($(u)+" message ",1)]),_:2},1032,["theme","onClick"])),64)}const C=h(k,[["render",Y]]),w=`<template>
