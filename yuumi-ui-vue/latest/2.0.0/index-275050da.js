import{_ as x,r as i,o as s,c as g,d as l,b as u,t as _,F as v,h as Y,a as C,f as h,w as p,e as V,u as c,g as w}from"./index-569afd91.js";const k={data(){return{value:""}},methods:{onChange(d){console.log(d)}}};function I(d,n,m,y,e,r){const o=i("YuumiInput");return s(),g(v,null,[l(o,{modelValue:e.value,"onUpdate:modelValue":n[0]||(n[0]=t=>e.value=t),placeholder:"请输入",style:{margin:"0 10px 10px 0"},onChange:r.onChange},null,8,["modelValue","onChange"]),u("div",null,"输入的内容为："+_(e.value),1)],64)}const B=x(k,[["render",I]]),E=`<template>
  <YuumiInput
    v-model="value"
    placeholder="请输入"
